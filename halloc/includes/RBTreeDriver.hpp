...
public:
     ...
     */
    RBTreeDriver(RBTreeDriver&& other) : root(other.root) { other.root = nullptr; }
     ...
     */
    void insert(T* node) { hh::rb_tree::insert(root, node); }
     ...
     */
    void remove(T* node) { hh::rb_tree::remove(root, node); }
