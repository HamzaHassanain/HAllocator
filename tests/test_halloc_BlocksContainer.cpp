 ...
 */
TEST(BlocksContainerTest, Constructor_InitializesWithOneBlock)
{
 ...
 */
TEST(BlocksContainerTest, Allocate_SingleAllocation)
{
    BlocksContainer<1024, 5> container;
 ...
 */
TEST(BlocksContainerTest, Allocate_MultipleAllocationsInSameBlock)
{
 ...
 */
TEST(BlocksContainerTest, Deallocate_AndReallocate)
{
 ...
 */
TEST(BlocksContainerTest, MultipleBlocks_CreatesNewBlockWhenNeeded)
{
 ...
 */
TEST(BlocksContainerTest, MultipleBlocks_AllocatesUpToMaxBlocks)
{
 ...
 */
TEST(BlocksContainerTest, BestFit_SelectsSmallestSuitableNode)
{
    ...
    void *ptr4 = container.allocate(1024 - 128 - 2 * MEMORY_NODE_SIZE); // must go into the first block
 ...
 */
TEST(BlocksContainerTest, BestFit_SearchesAcrossMultipleBlocks)
{
 ...
 */
TEST(BlocksContainerTest, EdgeCase_AllocateZeroBytes)
{
    BlocksContainer<1024, 5> container;
 ...
 */
TEST(BlocksContainerTest, EdgeCase_AllocateLargerThanBlockSize)
{
 ...
 */
TEST(BlocksContainerTest, EdgeCase_DeallocateInvalidPointer)
{
 ...
 */
TEST(BlocksContainerTest, DataIntegrity_WriteAndReadIntegers)
{
 ...
 */
TEST(BlocksContainerTest, DataIntegrity_WriteAndReadStructs)
{
    struct TestStruct
    {
        int id;
 ...
 */
TEST(BlocksContainerTest, DataIntegrity_MultipleAllocationsIndependent)
{
    BlocksContainer<4096, 5> container;
 ...
 */
TEST(BlocksContainerTest, Fragmentation_CoalescingAfterDeallocation)
{
...
/**
 * @test Many small allocations followed by deallocation allows large allocation (coalescence)
 */
TEST(BlocksContainerTest, Fragmentation_ManySmallAllocations)
{
}
 ...
 */
TEST(BlocksContainerTest, StressTest_RandomAllocationsAndDeallocations)
{
 ...
 */
TEST(BlocksContainerTest, StressTest_FillAllBlocks)
{
 ...
 */
TEST(BlocksContainerTest, StressTest_RandomLargeAndSmall)
{
    ...
    for (int i = 0; i < 10000; i++)
    {
        ...
        std::size_t size = is_large ? (64 * 1024 + (rand() % (256 * 1024 - 64 * 1024))) // 64KB to 256KB
 ...
 */
TEST(BlocksContainerTest, StressTest_VaryingSizes)
{
